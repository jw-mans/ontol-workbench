"""Generate SVG fixtures for SVG parser tests.

Keep this file for examples you want to develop iteratively from SVG inputs.
Run as: `python tests/scripts/generate_svg_parser_examples.py`.
"""
import sys
...
OUT_DIR = TESTS_ROOT / "fixtures" / "svg_parser"
OUT_DIR.mkdir(parents=True, exist_ok=True)


def save(diagram: ClassDiagram, filename: str, export_raster: bool = False) -> None:
