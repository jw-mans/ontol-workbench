...
class Directory(Base):
    """
    ORM-модель директории проекта.

    Директория может содержать файлы и другие директории, создавая иерархическую структуру.

    :param id: UUID директории
    :param project_id: UUID проекта
    :param parent_directory_id: UUID родительской директории или None (корневая директория)
    :param name: имя директории
    :param created_at: время создания директории
    :param files: список файлов в директории
    :param children: список поддиректорий
    """
